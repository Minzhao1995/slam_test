...
VisualOdometryStereo::VisualOdometryStereo () : param(param), VisualOdometry(param) {
...
void VisualOdometryStereo::  viso_setparameters ( parameters par )
 {
    cout<<"param.f"<<par.calib.f<<endl ;
    matcher->setIntrinsics(par.calib.f,par.calib.cu,par.calib.cv,par.base);
    param.calib.f=par.calib.f;
    param.calib.cu=par.calib.cu;
    param.calib.cv = par.calib.cv;
      param.base   = par.base;
    cout<<"param.f"<<param.calib.f<<endl ;
